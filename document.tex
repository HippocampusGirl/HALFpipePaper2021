...
\author[1,6,7\authfn{1}]{\mbox{Ilya M. Veer \orcid{0000-0002-6733-3593}}}
...
\affil[6]{Donders Institute for Brain, Cognition and Behaviour, Nijmegen, the Netherlands}
\affil[7]{Radboud University Medical Center, Nijmegen, the Netherlands}
...
generates an interactive quality assessment (QA) webpage to assess the quality
of key preprocessing outputs and raw data in general. \soft{HALFpipe} features
