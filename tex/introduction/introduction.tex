...
termed \term{analytic flexibility} \parencite{poldrack2017}. The steps
...
\parencite{botviniknezer2020}. Thus, \term{analytic flexibility}
...
empirically-derived best-practices \parencite{gruning2018}. For
instance, established pipelines such as \soft{fMRIPrep}
\parencite{esteban2019a} and \soft{C-PAC}
\parencite{craddock2013} have automated many of these choices. An
...
\parencite{steegen2016}, has the advantage that results from
...
reproducibility \parencite{thompson2020b}. The four ingredients that are
...
\parencite{esteban2019a} has grown in popularity due to its
...
\parencite{poldrack2019}. However, \soft{fMRIPrep}
...
\parencite{thompson2020a}. These workflows have successfully analyzed
...
\parencite[e.g.][]{schmaal2020,vandenheuvel2020,hoogman2020}.
...
ENIGMA task-based \parencite{veer2019b} and resting-state fMRI
\parencite{adhikari2019} working groups have spurred initiatives
