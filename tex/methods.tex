...
\parencite{10.1038/s41592-018-0235-4}, MRIQC
\parencite{10.1371/journal.pone.0184661}, FSL
\parencite{10.1016/j.neuroimage.2011.09.015}, ANTs
\parencite{10.1016/j.neuroimage.2010.09.025}, FreeSurfer
\parencite{10.1073/pnas.200033797}, and AFNI
...
\includegraphics[width=\linewidth]{fig/workflow-crop}\label{fig:workflow}
\caption{\textbf{HALFpipe workflow.} After minimal preprocessing with
fMRIPrep \parencite{10.1038/s41592-018-0235-4}, additional filtering of the
data can be selected. Based on the resulting preprocessed image, 
statistical maps can be calculated. }
\end{adjustwidth}
\end{figure}
